      ...
      <div className="mx-auto max-w-3xl px-6 py-16">
        ...
        <div className="mb-6">
          <div className="flex items-center gap-3 mb-6">
            <span className="px-2 py-0.5 rounded-sm bg-purple-500/10 text-purple-400 font-serif text-[9px] uppercase tracking-widest border border-purple-500/20">
              Complex Scenario
            </span>
          ...
          <p className="font-serif text-[10px] uppercase tracking-widest text-muted-foreground">
            Friday, 2:47 PM · Your second week at the company
          </p>
        </div>
        ...
        <div className="mb-12">
          <p className="text-sm text-muted-foreground leading-[1.8] mb-6">
            You're settling into your desk after lunch. The office is quieter than usual — half the
            team left early for the long weekend. Your Slack pings.
          </p>
            ...
            <div className="p-5 space-y-5">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-muted-foreground leading-relaxed">
                    Hey team — the client called again about the search abuse. We{' '}
                    <span className="text-foreground font-medium">
                      need rate limiting on{' '}
                      <code className="px-1 py-0.5 bg-secondary rounded-sm text-[11px]">
                        /api/search
                      </code>{' '}
                      before the 6pm deploy
                    </span>
                    . No exceptions. They're threatening to escalate.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-muted-foreground leading-relaxed">
                    @{'{you}'} — I'm assigning this to you. The repo has Express with a few
                    endpoints, Redis is already in the stack but unused. I'd go with a sliding
                    window approach.{' '}
                    <span className="text-foreground font-medium">
                      I'll review your PR before 5:30.
                    </span>
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-muted-foreground leading-relaxed">
                    I'll need to run the integration suite before we cut the release. Make sure the
                    tests don't break existing endpoints. Last time someone touched middleware, half
                    the suite went red 😬
                  </p>
                </div>
              </div>
          ...
          {team.map((m) => (
            ...
            >
              <div className="relative">
                ...
                <div
                  className={`absolute -bottom-0.5 -right-0.5 w-3 h-3 rounded-full ${m.color} border-2 border-card`}
                />
              </div>
    ...
    <div className="relative min-h-screen text-foreground overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col min-h-screen">
        ...
        <div className="fixed top-6 left-6 z-50 flex items-center gap-3">
          <Link
            href="/os"
            className="flex items-center gap-2 px-3 py-2 rounded-sm border border-border bg-card/80 backdrop-blur-sm text-muted-foreground hover:text-foreground transition-colors"
          >
            <ArrowLeft size={14} />
          ...
          <div className="fixed top-6 left-1/2 -translate-x-1/2 z-50 flex items-center bg-card/80 backdrop-blur-sm p-1 rounded-sm border border-border">
            {(
              ...
              <button
                ...
                className={`flex items-center gap-2 px-4 py-1.5 rounded-sm font-serif text-[10px] uppercase tracking-widest transition-all ${view === tab.id ? 'bg-foreground text-background font-bold' : 'text-muted-foreground hover:text-foreground'}`}
              >
                <tab.icon size={14} />
                {tab.label}
              </button>
