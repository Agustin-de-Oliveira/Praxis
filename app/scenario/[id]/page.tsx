...
export default async function RealScenarioPage({ params }: ScenarioPageProps) {
  ...
  const typedProgress: ScenarioProgress = {
    ...
    current_code_state: (progress?.current_code_state ?? scenario.repo_initial.files) as Record<
      string,
      string
    >,
  ...
  return <DesktopOrchestrator scenario={scenario} initialProgress={typedProgress} />
}
