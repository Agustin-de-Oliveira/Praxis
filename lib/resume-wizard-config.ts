...
export const RESUME_ROLES: {
...
}[] = [
  {
    ...
    icon: Globe,
    desc: 'UI/UX implementation, component architecture, and browser performance.',
  ...
  },
  {
    ...
    icon: Database,
    desc: 'API design, database architecture, and server-side logic.',
  ...
  },
  {
    ...
    icon: Code,
    desc: 'End-to-end features across the frontend and backend.',
  ...
  },
  {
    ...
    title: 'DevOps / SRE',
    icon: Cloud,
    desc: 'Infrastructure as code, CI/CD pipelines, and cloud orchestration.',
  ...
  },
  {
    ...
    icon: ShieldCheck,
    desc: 'Identity management, vulnerability assessment, and secure protocols.',
    skills: ['JWT/OAuth', 'Encryption', 'Pentesting', 'OWASP'],
  },
]
