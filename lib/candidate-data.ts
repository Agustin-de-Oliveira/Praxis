...
export const COMPANIES: Company[] = [
  {
    ...
    name: "LedgerLane",
    sector: "Fintech",
    summary: "A payments ledger team modernizing auth, audit trails, and customer-facing financial workflows.",
    signal: "Strict review culture, careful security posture, production incidents are treated as learning loops.",
  ...
  },
  {
    ...
    name: "OrbitCart",
    sector: "Commerce",
    summary: "A fast-moving storefront platform where performance, checkout reliability, and UI polish matter.",
    signal: "Frontend-heavy product work with backend edges around carts, inventory, and checkout APIs.",
    accent: "text-sky-400",
  ...
  },
  {
    ...
    name: "SignalForge",
    sector: "Devtools",
    summary: "An observability startup building internal tooling, CI workflows, and deployment guardrails.",
    signal: "Infra-minded team with high standards around logs, debugging, and operational communication.",
    accent: "text-[#a86f44]",
...
export const JOB_POSTINGS: JobPosting[] = [
  {
    ...
    description: "Work on account APIs, auth-adjacent flows, and internal ledger tools with senior review.",
  ...
  },
  {
    ...
    description: "Maintain internal services, debug failing pipelines, and improve deployment feedback loops.",
    challengeScenarioId: "SCN-008",
  },
]
