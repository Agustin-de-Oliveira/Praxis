  ...
  return (
    <div className="flex-1 flex flex-col bg-[#050505] overflow-y-auto">
        ...
        <div className="mt-8">
          <div className="flex items-center justify-between mb-2">
            <div className="flex items-center gap-2">
              ...
              <span className="font-mono text-[9px] text-white/30 uppercase tracking-widest">Experience Progression</span>
            </div>
          ...
          <div className="flex justify-between mt-2">
            <span className="font-mono text-[8px] text-white/10 uppercase tracking-widest">LVL {profile.level}</span>
            <span className="font-mono text-[8px] text-white/10 uppercase tracking-widest">{xpInLevel}/{XP_PER_LEVEL} XP to next level</span>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-3 gap-px bg-white/5 border-b border-white/5">
        {[
          { label: "Aggregate XP", value: profile.total_xp.toLocaleString(), icon: Zap, color: "text-[#a86f44]" },
          { label: "Current Streak", value: "1 Day", icon: Flame, color: "text-orange-400" },
          { label: "System Rank", value: String(profile.level), icon: Award, color: "text-purple-400" },
        ].map(stat => (
          <div key={stat.label} className="bg-[#050505] p-6 text-center">
            ...
            <p className="font-mono text-[9px] text-white/20 uppercase tracking-widest mt-1">{stat.label}</p>
          </div>
        ))}
      </div>
      ...
      <div className="p-8 border-b border-white/5">
        <p className="font-mono text-[9px] text-white/20 uppercase tracking-widest mb-4">Current Workstation Activity</p>
        {activeScenarioTitle ? (
          <div className="flex items-center gap-4 p-5 bg-[#a86f44]/5 border border-[#a86f44]/10">
            ...
            <div>
              ...
              <p className="font-mono text-[8px] text-[#a86f44] uppercase tracking-[0.2em] mt-1">Live Environment • In Progress</p>
            </div>
          </div>
        ) : (
          <div className="flex items-center gap-4 p-5 bg-white/[0.02] border border-white/5">
            ...
            <p className="font-mono text-[9px] text-white/20 uppercase tracking-widest">No active mission assignments detected.</p>
          </div>
        )}
      </div>
      ...
      {/* Account Security */}
      <div className="p-8 border-b border-white/5">
        <p className="font-mono text-[9px] text-white/20 uppercase tracking-widest mb-4">Security Credentials</p>
        <div className="flex items-center gap-4 p-5 bg-white/[0.01] border border-white/5">
          ...
          <div className="flex-1">
            ...
            <p className="font-mono text-[8px] text-white/10 uppercase tracking-widest mt-1">Status: Authenticated via Internal Gateway</p>
          </div>
        </div>
      </div>
