    ...
    if (cleanCmd === 'help') {
      ...
      if (isRepoCloned) {
        setLines((prev) => [
          ...
          '----                -------------         ------ ----',
          'd-----        05/08/2026  10:45 AM                src',
          'd-----        05/08/2026  10:45 AM                public',
          '-a----        05/08/2026  10:45 AM           1042 package.json',
          '-a----        05/08/2026  10:45 AM            244 README.md',
          '',
        ])
      } else {
        setLines((prev) => [
          ...
          '',
          '05/08/2026  09:12 AM    <DIR>          Documents',
          '05/08/2026  09:12 AM    <DIR>          Downloads',
          '05/08/2026  09:12 AM    <DIR>          Desktop',
          '               0 File(s)              0 bytes',
          '',
        ])
      }
      ...
      if (isRepoCloned && cleanCmd.startsWith('git clone')) {
        setLines((prev) => [
          ...prev,
          `fatal: destination path '${ticketKey.toLowerCase()}' already exists and is not an empty directory.`,
          '',
        ])
        return
      }
