      ...
      <div className="mx-auto max-w-5xl px-6 py-12">
        ...
        <div className="space-y-4">
          {members.map(([role, member]) => (
            <div key={role} className="p-6 rounded-sm border border-border bg-card flex items-start gap-5">
        ...
        {members.length === 0 && (
          <div className="py-20 text-center">
            <p className="text-sm text-muted-foreground italic">No team members assigned to this scenario.</p>
          </div>
        )}
      </div>
    </div>
