      ...
      <div className="mx-auto max-w-5xl px-6 py-12">
        ...
        <div className="mb-10">
          ...
          <p className="text-sm text-muted-foreground max-w-lg">
            Each scenario is a self-contained ticket — scoped, reviewed, and ready to ship. Pick one
            and start building.
          </p>
        </div>
              ...
              <div className="group card-hover rounded-sm border border-border bg-card p-6 cursor-pointer grid md:grid-cols-[1fr_auto] gap-6 items-start">
                ...
                <div className="flex flex-col gap-2">
                  <div className="flex items-center gap-3">
                    ...
                    <span
                      className={`px-1.5 py-0.5 rounded-sm border font-serif text-[9px] uppercase ${getTypeBadge(s.type)}`}
                    >
                      {s.type}
                    </span>
                  </div>
                ...
                <div className="flex md:flex-col items-end gap-3 md:gap-2 shrink-0">
                  <span
                    className={`rounded-sm border px-2 py-0.5 font-serif text-[9px] uppercase tracking-wider ${getDifficultyStyle(s.difficulty)}`}
                  >
                    {s.difficulty}
                  </span>
