...
const highlights = [
  {
    ...
    description:
      'Enter a high-fidelity OS. Check your mail, respond to incidents, and manage your team from a persistent terminal.',
  },
  {
    icon: Timer,
    title: 'Narrative Arcs',
    description:
      "Progression isn't just XP. It's reputation, trust, and access to more critical systems as you move from Trainee to Lead.",
  },
  {
    icon: Trophy,
    title: 'Real Feedback',
    description:
      'Not just checks. Get code reviews, team feedback, and post-mortems that feel human and carry emotional weight.',
  },
  {
    icon: Activity,
    title: 'Professional Survival',
    description:
      "Survive the Friday deploy, navigate technical debt, and make tradeoffs that impact the team's long-term health.",
  },
]
        ...
        {highlights.map((item, index) => {
          ...
          return (
            ...
            >
              ...
              <h4 className="text-base font-medium text-foreground mb-2 font-serif">
                {item.title}
              </h4>
